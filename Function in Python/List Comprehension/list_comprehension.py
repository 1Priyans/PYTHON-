...
for val in lst:
    ...
    print("Square list: {}".format(sqrlist))  # Square list: [144, 169, 1024, 529, 1849, 576, 4225, 4225, 9025]
...
print("Given List = {}".format(lst))
print("-"*80)
print("Square List = {}".format(reslst), type(reslst))  # Square list: [144, 169, 1024, 529, 1849, 576, 4225, 4225, 9025] <class 'list'>
...
print("Given List = {}".format(lst))
print("-"*80)
print("Square List = {}".format(reslst), type(reslst))  # Square List = {1024, 576, 4225, 9025, 169, 144, 529, 1849} <class 'set'> Bcoz set never maintains insertion order
...
print("Given List = {}".format(lst))
print("-"*80)
print("Square List = {}".format(reslst), type(reslst))  # <generator object <genexpr> at 0x000000F0475222D0> <class 'generator'>
tpl = tuple(reslst)
print("Square List = {}".format(tpl), type(tpl))  # (144, 169, 1024, 529, 1849, 576, 4225, 4225, 9025) <class 'tuple'>
...
print("Given List = {}".format(lst))
print("-"*80)
print("Square List = {}".format(reslst), type(reslst))  # Square List = {(-23, 529), (32, 1024), (-43, 1849), (65, 4225), (24, 576), (12, 144), (95, 9025), (13, 169), (-65, 4225)} <class 'set'>
...
print("-"*80)
dict = dict(reslst)
print("Square List = {}".format(dict), type(dict))  # Square List = {12: 144, 13: 169, 32: 1024, -23: 529, -43: 1849, 24: 576, 65: 4225, -65: 4225, 95: 9025} <class 'dict'>
